...
function ChangeColor(tableRow, highLight)
    ...
    if (highLight)
    { 
     if(tableRow.className=='evenRow'){
      tableRow.className = 'evenRow highlight';
      }  
      else{
      tableRow.className = 'oddRow highlight'  
      }
    }
    else
    {
        if(tableRow.className=='evenRow highlight'){
   ...
   $( "#library-accordion" ).accordion({
    ...
    $(window).resize(function(){       
     ...
     if(window.innerWidth <= 767){
        $(".side-nav").hide();
        $(".admissions-side-nav").hide();
        $(".contact-box").hide();
     }else{
        $("side-nav").show();
        $(".admissions-side-nav").show();
        $(".contact-box").show();
     }   
    });
  }
